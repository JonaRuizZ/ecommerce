        ...
        <div className="grid grid-cols-2">
            ...
            <div className="m-4 flex flex-col items-center justify-center">
                ...
                <div className="grid grid-cols-2 gap-4 m-4">
                    <button className="bg-green-400 py-3 rounded-lg hover:bg-green-500 duration-300 text-white mt-1 px-4 flex gap-2" onClick={addToCart}>
                        Agregar al carrito
